  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-16 space-y-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="p-6 sm:p-7 rounded-3xl bg-white border border-[#C1E5FF] space-y-3 shadow-sky-card">
      ...
      <div className="rounded-3xl bg-white border border-[#C1E5FF] p-8 sm:p-10 space-y-6 shadow-sky-card">
      ...
      <div className="rounded-3xl bg-white border border-[#C1E5FF] p-8 sm:p-10 flex flex-col sm:flex-row items-center justify-between gap-6 shadow-sky-card">
