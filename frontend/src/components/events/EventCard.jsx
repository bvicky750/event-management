...
export const EventCard = ({ event, variant = 'standard' }) => {
  ...
  if (variant === 'featured_large') {
    return (
      <div className="group relative rounded-3xl bg-white/85 backdrop-blur-md border border-[#C1E5FF] hover:border-[#6AB0E3] transition-all duration-300 shadow-sky-card hover:shadow-sky-hover overflow-hidden flex flex-col lg:flex-row">
        {/* Poster Media */}
  ...
  return (
    <div className="group rounded-2xl bg-white/85 backdrop-blur-md border border-[#C1E5FF] hover:border-[#6AB0E3] hover:bg-white/95 transition-all duration-300 flex flex-col justify-between overflow-hidden shadow-sky-card hover:shadow-sky-hover">
      <div>
        {/* Poster Frame */}
