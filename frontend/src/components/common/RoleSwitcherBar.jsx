...
export const RoleSwitcherBar = () => {
  ...
  return (
    <div className="bg-[#EAF6FF] text-[#1E3A5F] text-xs py-1.5 px-4 border-b border-[#C1E5FF] flex flex-wrap items-center justify-between gap-3 sticky top-0 z-50 shadow-xs">
      <div className="flex items-center gap-2">
        ...
        <div className="flex items-center gap-1.5 bg-white px-2.5 py-0.5 rounded-lg border border-[#C1E5FF]">
          {role === 'student' ? (
      ...
      <div className="flex items-center gap-1.5 sm:gap-2">
        <button
          ...
          className={`px-2.5 py-0.5 rounded-md text-[11px] font-bold border transition flex items-center gap-1 ${
            role === 'student'
              ? 'bg-[#6AB0E3] text-white border-[#6AB0E3] shadow-xs'
              : 'bg-white text-[#1E3A5F] border-[#C1E5FF] hover:bg-[#C1E5FF]'
          }`}
        >
        ...
        <button
          ...
          className={`px-2.5 py-0.5 rounded-md text-[11px] font-bold border transition flex items-center gap-1 ${
            role === 'staff'
              ? 'bg-[#0F2238] text-white border-[#0F2238] shadow-xs'
              : 'bg-white text-[#1E3A5F] border-[#C1E5FF] hover:bg-[#C1E5FF]'
          }`}
        >
        ...
        <button
          ...
          className="ml-1 px-2 py-0.5 bg-white hover:bg-rose-50 hover:text-rose-600 hover:border-rose-200 text-[#5B7B9C] rounded-md transition flex items-center gap-1 text-[10px] border border-[#C1E5FF]"
        >
