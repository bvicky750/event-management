...
export const Footer = () => {
  return (
    <footer className="bg-white border-t border-[#C1E5FF] text-[#5B7B9C] text-xs">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16 space-y-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 font-medium">
              <li>
                <Link to="/events?type=club_event" className="hover:text-[#6AB0E3] transition flex items-center gap-1">
                  <span>T&P Club Events</span>
                </Link>
              </li>
              <li>
                <Link to="/events?type=external_opportunity" className="hover:text-[#6AB0E3] transition flex items-center gap-1">
                  <span>External Opportunities</span>
                </Link>
              </li>
              <li>
                <Link to="/events?category=Career" className="hover:text-[#0F2238] transition">
                  Placement Prep
                </Link>
              </li>
              <li>
                <Link to="/events?category=Aptitude" className="hover:text-[#0F2238] transition">
                  Aptitude Challenges
                </Link>
              </li>
              <li>
                <Link to="/events?category=Hackathon" className="hover:text-[#0F2238] transition">
                  Hackathons
                </Link>
              </li>
            </ul>
        ...
        <div className="pt-8 border-t border-[#EAF6FF] flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] text-[#5B7B9C] font-semibold">
          ...
          <div className="flex items-center gap-4">
            ...
            <span>•</span>
            <Link to="/events" className="hover:text-[#0F2238] transition">All Events</Link>
          </div>
        </div>
      </div>
    </footer>
