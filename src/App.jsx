...
const PublicLayout = () => {
  return (
    <div className="min-h-screen flex flex-col bg-[#EAF6FF] text-[#0F2238] selection:bg-[#6AB0E3] selection:text-white">
      <RoleSwitcherBar />
      <PublicNavbar />
...
const PortalLayout = ({ roleRequired }) => {
  ...
  return (
    <ProtectedRoute allowedRoles={[roleRequired]}>
      <div className="min-h-screen flex flex-col bg-[#EAF6FF] text-[#0F2238]">
        <RoleSwitcherBar />
        <div className="flex-1 flex">
          ...
          <div className="flex-1 flex flex-col min-w-0 bg-[#EAF6FF]">
            <DashboardNavbar
